                    ...
                    <div className='third-div'>
                        ...
                        <div className='filter-div'>
                            <label htmlFor="sort-electronics">
                                <input className='filter-checkbox' type="checkbox" value="Electronics" onChange={(event) => {
                                    dispatch( {type: "CHECKBOX_INPUT", payload: event.target.value})
                                }} id='sort-electronics' />
                                Electronics
                            </label>
                            <label htmlFor="sort-appliances">
                                <input className='filter-checkbox' type="checkbox" value="Appliances" onChange={(event) => {
                                    dispatch( {type: "CHECKBOX_INPUT", payload: event.target.value})
                                }} id='sort-appliances' />
                                Appliances
                            </label>
                            <label htmlFor="sort-clothings">
                                <input className='filter-checkbox' type="checkbox" value="Cloths" onChange={(event) => {
                                    dispatch( {type: "CHECKBOX_INPUT", payload: event.target.value})
                                }} id='sort-clothings' />
                                Clothings
                            </label>
                            <label htmlFor="sort-furniture">
                                <input className='filter-checkbox' type="checkbox" value="Furniture" onChange={(event) => {
                                    dispatch( {type: "CHECKBOX_INPUT", payload: event.target.value})
                                }} id='sort-furniture' />
                                Furniture
                            </label>
